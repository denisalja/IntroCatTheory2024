...
\[ f \tilde g \iff F(f) = F(g).\]
\end{proof}

\begin{defn}
The \textbf{localization} of $\cC$ by a congruence on hom-sets is the category whose objects are those of $\cC$ and whose arrows are equivalence classes in the hom-set quotients. 
\end{defn}
