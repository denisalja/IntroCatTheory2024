...
\begin{rem}
This works for rings. A similar localization construction works for categories but we can't do quite the same thing to make a factorization system; we need to take a colimit of all the factorizations. 
\end{rem}
\end{eg*}
\end{document}